...
pub use snapshot::{
    ...
    CallSiteResolution, CallableIdentityScope, CompletenessBasis, CorrespondenceClaim,
    CorrespondenceClaimId, Derivation, EvidenceId, EvidenceRecord, EvidenceScope, EvidenceSupport,
    Explanation, ExplanationHandle, Manifestation, ManifestationId, NamedQueryResult,
    ObservationContext, ObservationContextId, ProgramEntity, ProgramEntityId, ProgramEntityKind,
    ProgramSnapshot, ProgramSnapshotId, ProjectedCallSite, ProjectedCallTarget, PublishedSnapshot,
    Resolution, SNAPSHOT_SCHEMA_VERSION, SourceLocation, TargetClaim, TargetClaimId,
};
