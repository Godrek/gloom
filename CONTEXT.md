...
**Published snapshot**:
An immutable program snapshot made available for queries after its required evidence and indexes are coherent. Coherence is a property of the published snapshot itself rather than of the act of publishing or reading one, and in-progress indexing does not mutate a published snapshot.
